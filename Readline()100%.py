...
def parseRowTrack(row_track):
    trackDict = {}
    track_num = row_track[0:3]
    track_valido = row_track[13:16]
    ieee754_value = row_track[-4:]  # might not work, so maybe  row_track[17:20]
    trackDict = { "track_valido": track_valido , "ieee754_value" : ieee754_value }
